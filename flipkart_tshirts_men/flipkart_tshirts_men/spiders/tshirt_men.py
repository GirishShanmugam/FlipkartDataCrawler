    ...
    def parse(self, response):
        ...
        if data is not None:
            ...
            with open('result.csv', 'a') as csvfile:
                fieldnames = ['id', 'url', 'flipkart_product_id', 'file_name']
                ...
                for product in raw_json['productSummary']:
                    try:
                        ...
                        for image in images_list:
                            ...
                            writer.writerow({'id': self.item_id, 'url': image_url, 'flipkart_product_id': flipkart_item_id,
                                             'file_name': str(self.item_id)+'.jpeg'})
